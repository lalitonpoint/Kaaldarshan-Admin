...
const addsupport = [ 
    ...
    async (req, res) => {
        ...
        if (!req.session || !req.session.user || !req.session.user.id) {
            ...
            console.log('help  inserted successfully:', blog);
...
async function get_all_support_ajax(req, res) {
    ...
    try {
        ...
        const totalCount = await help.count({
        ...
        const filteredCount = await help.count({ where: whereClause });

        // Get filtered data
        const about = await help.findAll({
